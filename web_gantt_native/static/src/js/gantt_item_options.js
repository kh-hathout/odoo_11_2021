...
var GanttListOptionsItem = Widget.extend({
    ...
    start: function () {
        ...
        if (this.parent.ItemsSorted){
            ...
            // var div_name = $('<div class="task-gantt-item-sort-name"/>');
            // div_name.css({"text-align": "left"});
            // div_name.text(this.parent.fields[this.parent.state.orderedBy[0].name].string);
            ...
            //
            // div_typer.text("  "+this.parent.fields[this.parent.state.orderedBy[0].name].string);
            //
            // div_typer.css("margin-left", "5px" );


            // this.$el.append(div_name);
            //this.$el.append(div_typer);
    ...
    on_global_click: function (ev) {
        ...
        if (!ev.isTrigger) { //human detect
            ...
            // if ($(ev.target).hasClass("task-gantt-item-sort-manual" )) {
            //
            //     // this.trigger_up('item_order', {
            //     //     orderedBy: this.parent.state.orderedBy,
            //     // });
            //
            //     this.parent.state.ItemsSortedDisable = true;
            //     // this.parent.state.data.ItemsSorted = false;
            //     this.parent.trigger_up('gantt_refresh_after_change' )
            //
            // }
