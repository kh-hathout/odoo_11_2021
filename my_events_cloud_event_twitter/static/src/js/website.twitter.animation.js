...
sAnimation.registry.twitter = sAnimation.Class.extend({
    selector: ".twitter",
    xmlDependencies: ['/my_events_cloud_event_twitter/static/src/xml/website.twitter.xml'],
    start: function () {
        var self = this;
        ...
        $("<center><div><img src='/my_events_cloud_event_twitter/static/src/img/loadtweet.gif'></div></center>").appendTo(timeline);
    ...
    render: function (data){
        ...
        $.each(data, function (e, tweet) {
            ...
            tweets.push(qweb.render("mec.Twitter.Tweet", {'tweet': tweet}));
        });
        ...
        if (!_.isEmpty(tweets)) {
            ...
            this.$scroller = $(qweb.render("mec.Twitter.Scroller"));
