...
class ProjectTaskNativeCalendar(models.Model):
            ...
            for inx, attendance in enumerate(attendances):
                ...
                for _res in task_res:
                    ...
                    if attendance["calendar_id"] == _calendar_id and diff_e > timedelta(hours=0):
                        ...
                        work_time, work_time_already = self._get_work_intervals(_resource_id, work_already_day, work_time_day, _load_factor)
                        ...
                        global_leave_ids = self.check_load_control(_load_control, _calendar_id, _resource_id, global_leave_ids_param, direct)
    ...
    def _get_planned_interval_revers(self, t_params, end_date, diff, level=None, tz_name=None, iteration=None, task=None):
